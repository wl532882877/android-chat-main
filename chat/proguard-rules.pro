...
-keep class cn.rjx.chat.app.login.model.** {*;}
-keepclassmembers class cn.rjx.chat.app.login.model.** {
  *;
}

-keep class cn.rjx.chat.kit.net.base.** {*;}
-keepclassmembers class cn.rjx.chat.kit.net.base.** {
  *;
}

-keep class cn.rjx.chat.kit.group.GroupAnnouncement {*;}
-keepclassmembers class cn.rjx.chat.kit.group.GroupAnnouncement {
  *;
}
