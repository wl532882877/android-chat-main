...
import cn.rjx.chat.BuildConfig;
import cn.rjx.chat.app.login.model.LoginResult;
import cn.rjx.chat.app.login.model.PCSession;
...
import cn.rjx.chat.kit.net.SimpleCallback;
import cn.rjx.chat.kit.net.base.StatusResult;
...
public class AppService implements AppServiceProvider {
     ...
     * <br>
     */
    //public static String APP_SERVER_ADDRESS/*请仔细阅读上面的注释*/ = "http://47.74.91.81:8888";
   // public static String APP_SERVER_ADDRESS/*请仔细阅读上面的注释*/ = "http://192.168.0.108:8888";
    public static String APP_SERVER_ADDRESS/*请仔细阅读上面的注释*/ = "http://119.8.44.69:8888";
